...
console.log(
  `Synced: ${syncResult.pushed + syncResult.pulled}, Conflicts: ${
...
console.log(
  `Deleted: ${pruneResult.deleted}, Freed: ${pruneResult.freed} bytes`
);

// Get usage metrics
const usage = await manager.getUsageMetrics();
console.log(
  `Total: ${usage.totalBytes} bytes, Cost: $${usage.estimatedMonthlyCost}/month`
);
