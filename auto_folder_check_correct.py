...
class FolderChecker:
    ...
    def check_repo(self, repo_path: Path, structure: FolderStructure) -> FolderCheckResult:
...
class FolderCorrector:
    ...
    def correct_all_repos(self, check_results: Dict[str, FolderCheckResult]) -> Dict[str, bool]:
