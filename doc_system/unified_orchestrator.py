...
class UnifiedOrchestrator:
    ...
    def search_documents(
        ...
        results = self.index.search_documents(
            query, tag_filter, doc_type_filter, status_filter
        )
        self._log_operation(
            "search_documents", {"query": query, "results": len(results)}
        )
        return results
    ...
    def update_roadmap_item(
        ...
        try:
            ...
            self._log_operation(
                "update_roadmap_item", {"item_id": item_id, "status": status}
            )
    ...
    def link_document_to_roadmap(
        ...
        self._log_operation(
            ...
            {"doc_id": doc_id, "roadmap_id": roadmap_item_id},
        )
        return success, message
    ...
    def get_roadmap_progress(self) -> Dict:
        ...
        self._log_operation(
            "get_roadmap_progress", {"completion": progress["completion_percent"]}
        )
        return progress
    ...
    def link_document_to_todo(self, doc_id: str, todo_id: str) -> Tuple[bool, str]:
        ...
        self._log_operation(
            "link_document_to_todo", {"doc_id": doc_id, "todo_id": todo_id}
        )
        return success, message
    ...
    def get_todo_progress(self) -> Dict:
        ...
        self._log_operation(
            "get_todo_progress", {"completion": progress["completion_percent"]}
        )
        return progress
    ...
    def validate_file(
        self, file_path: str, roadmap_item_id: str = None, todo_id: str = None
    ) -> Tuple[bool, str]:
        """Validate a file with optional roadmap/todo linkage"""
        success, message = self.validator.validate_file(
            file_path, roadmap_item_id, todo_id
        )
    ...
    def validate_directory(
        ...
        self._log_operation(
            "validate_directory",
            {"directory": directory, "files": validated, "issues": issues},
        )
    ...
    def validate_and_commit(
        ...
        self._log_operation(
            "validate_and_commit", {"roadmap_id": roadmap_item_id, "todo_id": todo_id}
        )
        return success, message
    ...
    def get_validation_report(self) -> Dict:
        ...
        self._log_operation(
            "get_validation_report", {"total_issues": report["total_issues"]}
        )
        return report
    ...
    def complete_work_item(
        ...
        try:
            ...
            # Update roadmap item
            success, msg = self.update_roadmap_item(
                roadmap_item_id, "completed", actual_hours
            )
            if not success:
    ...
    def get_work_item_status(self, roadmap_item_id: str, todo_id: str) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "status": (
                    "aligned"
                    if roadmap_item.get("status") == todo.get("status")
                    else "misaligned"
                ),
                "progress": {
