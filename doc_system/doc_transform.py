...
class DocTransformSystem:
    ...
    def _log_transform(self, source_id: str, target_format: str, 
    ...
    def markdown_to_json(self, content: str, preserve_structure: bool = True) -> Dict[str, Any]:
    ...
    def transform(self, content: str, source_format: str, 
                 target_format: str, config: Optional[TransformConfig] = None) -> Tuple[bool, str]:
        """
        ...
        try:
            ...
            if source_format == "markdown" and target_format == "json":
                ...
                return False, f"Unsupported transformation: {source_format} -> {target_format}"
            
        except Exception as e:
            logger.error(f"Transform failed: {e}")
            return False, str(e)
    
    def batch_transform(self, documents: List[Tuple[str, str, str]], 
                       target_format: str) -> List[Tuple[bool, str]]:
        """
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "failed": failed,
            "success_rate": round(successful / len(self.transformations) * 100, 2) if self.transformations else 0
        }
