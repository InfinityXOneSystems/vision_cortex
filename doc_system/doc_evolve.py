...
class DocEvolveSystem:
    ...
    def create_version(self, doc_id: str, content: str, 
                      change_summary: str = "", author: str = "system") -> str:
        """
    ...
    def _detect_improvements(self, old_content: str, new_content: str) -> List[str]:
        ...
        if new_len > old_len * 1.1:
            improvements.append(f"Expanded by {round((new_len - old_len) / old_len * 100, 1)}%")
        ...
        if new_score > old_score:
            improvements.append(f"Quality improved from {old_score:.1f} to {new_score:.1f}")
    ...
    def apply_improvement(self, doc_id: str, content: str, 
    ...
    def get_statistics(self, doc_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_improvements": sum(
                len(v.improvements) for v in versions
            )
        }
