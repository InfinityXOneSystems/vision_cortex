...
class DocCreateSystem:
    ...
    def __init__(
        self, templates_dir: str = "doc_templates", output_dir: str = "docs_created"
    ):
    ...
    def create_from_template(
        ...
        try:
            ...
            content = self._build_from_structure(
                template.structure, data, template.format
            )
    ...
    def _build_markdown(self, structure: Dict[str, Any], data: Dict[str, Any]) -> str:
    ...
    def _build_json(
        self, structure: Dict[str, Any], data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """Build JSON document"""
        result = {}
    ...
    def _build_plaintext(self, structure: Dict[str, Any], data: Dict[str, Any]) -> str:
    ...
    def save_document(
        self, doc_id: str, content: str, format_type: str = "md"
    ) -> Tuple[bool, str]:
        """
        ...
        try:
            extension = (
                format_type if format_type.startswith(".") else f".{format_type}"
            )
    ...
    def batch_create(
        self, template_id: str, data_list: List[Dict[str, Any]]
    ) -> List[Tuple[bool, str]]:
        """
...
if __name__ == "__main__":
    ...
    # Create document
    success, content = creator.create_from_template(
        "readme",
        {
